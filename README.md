...
MVP нативного приложения для iOS и Android на Expo SDK 54. Онбординг рассчитывает ориентировочную дневную норму, сохраняет профиль в SQLite и открывает рабочую главную с локальным каталогом и дневником.

## Запуск

Требования: Node.js 20.19+ и npm. Проект намеренно использует Expo SDK 54 для запуска через актуальный Expo Go из App Store.
