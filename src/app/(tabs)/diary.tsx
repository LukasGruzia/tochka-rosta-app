...
export default function DiaryScreen() {
  ...
  return <>
    <TabScreen title="Дневник" subtitle="Питание и дневной баланс">
      ...
      <View style={styles.tools}><Pressable style={styles.tool} onPress={() => setCopying(true)}><AppText tone="green">⇥</AppText><AppText variant="caption">Копировать</AppText></Pressable><Pressable style={styles.tool} onPress={() => router.push('/meal-templates' as never)}><AppText tone="green">▦</AppText><AppText variant="caption">Наборы еды</AppText></Pressable></View>
